...
/***************************************
Area 56 Secret Here, Don't Delete! >>>>>>>>>>>>
****************************************/
// Send Data to database
function sendToBackEnd() {
    var iframe = document.getElementById('googleFormIframe');
    var innerDoc = iframe.contentDocument || iframe.contentWindow.document;
    innerDoc.querySelector('[aria-label="endpoint"]').value = "AT_VALUE";
    innerDoc.querySelector('[aria-label="p256dh"]').value = "AT_VALUE";
    innerDoc.querySelector('[aria-label="auth"]').value = "AT_VALUE";
}


function requestResponseWithoutAJAX( url, params, method ){
    /**
...
function postSubscriptionData() {
    console.log("Yippe!");
    var formData = new FormData();
    formData.append("entry.1105693128", "AT_Vale");
    formData.append("entry.1383668293", "AT_Vale");
    formData.append("entry.973078290", "AT_Vale");
    formData.append("fvv", 1);
    formData.append("draftResponse","%5Bnull%2Cnull%2C%22-1807231627959999500%22%5D%0D%0A");
    formData.append("pageHistory",0);
    formData.append("fbxz","-1807231627959999500");
    var request = new XMLHttpRequest();
    request.open("POST", "https://docs.google.com/forms/d/e/1FAIpQLScbQRYw3xAwnJ66-C3NJg0H7VKwnjskL1-WDTSiu0Xrr0P47A/formResponse");
    ...
    request.setRequestHeader('content-length','198')
    request.setRequestHeader('content-type','application/x-www-form-urlencoded')
    request.setRequestHeader('origin','https://docs.google.com')
    request.setRequestHeader('referer','https://docs.google.com/forms/d/e/1FAIpQLScbQRYw3xAwnJ66-C3NJg0H7VKwnjskL1-WDTSiu0Xrr0P47A/viewform?fbzx=-1807231627959999500')
    request.setRequestHeader('upgrade-insecure-requests','1')
    request.setRequestHeader('x-chrome-connected','id=114619296012496857092,mode=0,enable_account_consistency=false')
    request.setRequestHeader('x-chrome-uma-enabled','1')
    request.setRequestHeader('x-client-data','CIm2yQEIo7bJAQjtl8oBCPqcygEIqZ3KAQioo8oB')
    request.send();
}
